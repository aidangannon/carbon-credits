...
public partial class Retire_Credit
{
    ...
    [Scenario]
    public Task When_Credit_Does_Not_Exist_On_Account_Not_Found_Should_Be_Returned()
    {
        return Runner.RunScenarioAsync(
            given => An_Account_Exists_With_An_Unretired_Credit(),
            when => A_Retire_Credit_Request_Is_Sent(_accountId, Guid.NewGuid()),
    ...
    {
        return Runner.RunScenarioAsync(
            given => An_Account_Exists_With_An_Already_Retired_Credit(),
            when => A_Retire_Credit_Request_Is_Sent(_accountId, _creditId),
    ...
    {
        return Runner.RunScenarioAsync(
            given => An_Account_Created_In_The_Future_Exists_With_An_Unretired_Credit(),
            when => A_Retire_Credit_Request_Is_Sent(_accountId, _creditId),
    ...
    {
        return Runner.RunScenarioAsync(
            given => An_Account_Exists_With_A_Credit_Issued_In_The_Future(),
            when => A_Retire_Credit_Request_Is_Sent(_accountId, _creditId),
